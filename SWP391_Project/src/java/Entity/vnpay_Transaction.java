...
public class vnpay_Transaction {
    ...
    public vnpay_Transaction(int ID, String status, int Wallet_id) {
        this.ID = ID;
        this.status = status;
        this.Wallet_id = Wallet_id;
    }

    public vnpay_Transaction(String status, int Wallet_id, String Payment_Code, String Time, String Description, String BankCode) {
        //this.ID = ID;
        this.status = status;
        this.Wallet_id = Wallet_id;
        this.Payment_Code = Payment_Code;
