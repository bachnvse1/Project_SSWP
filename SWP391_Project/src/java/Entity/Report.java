...
public class Report {
    ...
    public Report(int id, int type_report, int orderID, boolean status, String desciption, int create_by, Timestamp create_At, Timestamp update_At, int update_by, boolean is_delete) {
        this.id = id;
