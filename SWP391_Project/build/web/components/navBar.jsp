                    ...
                    <ul class="header-links pull-right">
                        <c:if test="${user != null}">
                            <li id="notification-Button"><a><i class="fa fa-bell"></i>
                                    Thông báo</a></li>\
                                    <li id="notification-Button"><a href="Deposite.jsp"><i class="fa fa-map-marker"></i>
                                    Quan lí giao dịch</a></li>
                            ...
                            <li><a><i class="fa fa-user-o"></i></a></li>
                                    ...
                                    <c:if test="${user == null}">
                            <li ><button style="color:red; border: 0; background-color: #1E1F29;" id="signin-Button">Đăng nhập</button></li>
                            </c:if>
                            <c:if test="${user != null}">
                            <li><button style="color:red; border: 0; background-color: #1E1F29;" id="logout-Button">Đăng xuất</button></li>
                            </c:if>
